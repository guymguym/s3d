...
{
    fn into_response(self) -> axum_core::response::Response {
        match crate::operation_ser::serialize_delete_bucket_analytics_configuration_response(
            &self.0,
        ) {
            Ok(response) => response,
            Err(e) => e.into_response(),
...
{
    fn into_response(self) -> axum_core::response::Response {
        match crate::operation_ser::serialize_delete_bucket_inventory_configuration_response(
            &self.0,
        ) {
            Ok(response) => response,
            Err(e) => e.into_response(),
...
{
    fn into_response(self) -> axum_core::response::Response {
        match crate::operation_ser::serialize_get_bucket_notification_configuration_response(
            &self.0,
        ) {
            Ok(response) => response,
            Err(e) => e.into_response(),
...
{
    fn into_response(self) -> axum_core::response::Response {
        match crate::operation_ser::serialize_put_bucket_notification_configuration_response(
            &self.0,
        ) {
            Ok(response) => response,
            Err(e) => e.into_response(),
        ...
        From<<B as aws_smithy_http_server::HttpBody>::Error>,
{
    type Rejection = aws_smithy_http_server::rejection::SmithyRejection;
    async fn from_request(
        _req: &mut axum_core::extract::RequestParts<B>,
    ) -> Result<Self, Self::Rejection> {
