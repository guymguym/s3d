...
pub enum S3OpsCommands {
    ...
    # [clap (about = "This action filters the contents of an Amazon S3 object based on a simple structured query language (SQL) statement. In the request, along with the SQL expression, you must also specify a data serialization format (JSON, CSV, or Apache Parquet) of the object. Amazon S3 uses this format to parse object data into records, and returns only records that match the specified SQL expression. You must also specify the data serialization format for the response." , long_about = None)]
...
impl S3OpsCommands {
    pub async fn run(&self, s3: &'static aws_sdk_s3::Client) {
        match self {
            ...
            S3OpsCommands::WriteGetObjectResponse(cmd) => cmd.run(s3).await,
            ...
            S3OpsCommands::SelectObjectContent(cmd) => cmd.run(s3).await,
...
#[derive(clap :: Parser, Debug, Clone)]
pub struct WriteGetObjectResponseCommand {
    # [clap (long = "body" , name = "Body" , help = "The object data." , long_help = None)]
    body: Option<Vec<u8>>,
    # [clap (long = "parts-count" , name = "PartsCount" , help = "The count of parts this object has." , long_help = None)]
    ...
    # [clap (long = "request-token" , name = "RequestToken" , help = "A single use encrypted token that maps <code>WriteGetObjectResponse</code> to the end user <code>GetObject</code> request." , long_help = None)]
    request_token: String,
    # [clap (long = "content-language" , name = "ContentLanguage" , help = "The language the content is in." , long_help = None)]
    content_language: Option<String>,
    # [clap (long = "replication-status" , name = "ReplicationStatus" , help = "Indicates if request involves bucket that is either a source or destination in a Replication rule. For more information about S3 Replication, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication.html\">Replication</a>." , long_help = None)]
    replication_status: Option<String>,
    # [clap (long = "content-range" , name = "ContentRange" , help = "The portion of the object returned in the response." , long_help = None)]
    ...
    # [clap (long = "object-lock-legal-hold-status" , name = "ObjectLockLegalHoldStatus" , help = "Indicates whether an object stored in Amazon S3 has an active legal hold." , long_help = None)]
    ...
    # [clap (long = "sse-customer-key-md5" , name = "SSECustomerKeyMD5" , help = "128-bit MD5 digest of customer-provided encryption key used in Amazon S3 to encrypt data stored in S3. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html\">Protecting data using server-side encryption with customer-provided encryption keys (SSE-C)</a>." , long_help = None)]
    sse_customer_key_md5: Option<String>,
    # [clap (long = "checksum-sha1" , name = "ChecksumSHA1" , help = "This header can be used as a data integrity check to verify that the data received is the same data that was originally sent. This specifies the base64-encoded, 160-bit SHA-1 digest of the object returned by the Object Lambda function. This may not match the checksum for the object stored in Amazon S3. Amazon S3 will perform validation of the checksum values only when the original <code>GetObject</code> request required checksum validation. For more information about checksums, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html\">Checking object integrity</a> in the <i>Amazon S3 User Guide</i>." , long_help = None)]
    checksum_sha1: Option<String>,
    # [clap (long = "last-modified" , name = "LastModified" , help = "The date and time that the object was last modified." , long_help = None)]
    last_modified: Option<String>,
    # [clap (long = "e-tag" , name = "ETag" , help = "An opaque identifier assigned by a web server to a specific version of a resource found at a URL." , long_help = None)]
    e_tag: Option<String>,
    # [clap (long = "status-code" , name = "StatusCode" , help = "The integer status code for an HTTP response of a corresponding <code>GetObject</code> request." , long_help = None)]
    ...
    # [clap (long = "request-charged" , name = "RequestCharged" , help = "" , long_help = None)]
    request_charged: Option<String>,
    # [clap (long = "storage-class" , name = "StorageClass" , help = "Provides storage class information of the object. Amazon S3 returns this header for all objects except for S3 Standard storage class objects." , long_help = None)]
    ...
    # [clap (long = "content-length" , name = "ContentLength" , help = "The size of the content body in bytes." , long_help = None)]
    content_length: Option<i64>,
    # [clap (long = "expiration" , name = "Expiration" , help = "If the object expiration is configured (see PUT Bucket lifecycle), the response includes this header. It includes the <code>expiry-date</code> and <code>rule-id</code> key-value pairs that provide the object expiration information. The value of the <code>rule-id</code> is URL-encoded." , long_help = None)]
    expiration: Option<String>,
    # [clap (long = "object-lock-mode" , name = "ObjectLockMode" , help = "Indicates whether an object stored in Amazon S3 has Object Lock enabled. For more information about S3 Object Lock, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lock.html\">Object Lock</a>." , long_help = None)]
    object_lock_mode: Option<String>,
    # [clap (long = "missing-meta" , name = "MissingMeta" , help = "Set to the number of metadata entries not returned in <code>x-amz-meta</code> headers. This can happen if you create metadata using an API like SOAP that supports more flexible metadata than the REST API. For example, using SOAP, you can create metadata whose values are not legal HTTP headers." , long_help = None)]
    missing_meta: Option<i32>,
    # [clap (long = "object-lock-retain-until-date" , name = "ObjectLockRetainUntilDate" , help = "The date and time when Object Lock is configured to expire." , long_help = None)]
    object_lock_retain_until_date: Option<String>,
    # [clap (long = "version-id" , name = "VersionId" , help = "An ID used to reference a specific version of the object." , long_help = None)]
    version_id: Option<String>,
    ...
    # [clap (long = "sse-customer-algorithm" , name = "SSECustomerAlgorithm" , help = "Encryption algorithm used if server-side encryption with a customer-provided encryption key was specified for object stored in Amazon S3." , long_help = None)]
    sse_customer_algorithm: Option<String>,
    # [clap (long = "delete-marker" , name = "DeleteMarker" , help = "Specifies whether an object stored in Amazon S3 is (<code>true</code>) or is not (<code>false</code>) a delete marker." , long_help = None)]
    delete_marker: Option<bool>,
    # [clap (long = "accept-ranges" , name = "AcceptRanges" , help = "Indicates that a range of bytes was specified." , long_help = None)]
    accept_ranges: Option<String>,
    # [clap (long = "bucket-key-enabled" , name = "BucketKeyEnabled" , help = "Indicates whether the object stored in Amazon S3 uses an S3 bucket key for server-side encryption with Amazon Web Services KMS (SSE-KMS)." , long_help = None)]
    bucket_key_enabled: Option<bool>,
    # [clap (long = "error-code" , name = "ErrorCode" , help = "A string that uniquely identifies an error condition. Returned in the <Code> tag of the error XML response for a corresponding <code>GetObject</code> call. Cannot be used with a successful <code>StatusCode</code> header or when the transformed object is provided in the body. All error codes from S3 are sentence-cased. The regular expression (regex) value is <code>\"^[A-Z][a-zA-Z]+$\"</code>." , long_help = None)]
    error_code: Option<String>,
    # [clap (long = "tag-count" , name = "TagCount" , help = "The number of tags, if any, on the object." , long_help = None)]
    tag_count: Option<i32>,
    # [clap (long = "error-message" , name = "ErrorMessage" , help = "Contains a generic description of the error condition. Returned in the <Message> tag of the error XML response for a corresponding <code>GetObject</code> call. Cannot be used with a successful <code>StatusCode</code> header or when the transformed object is provided in body." , long_help = None)]
    error_message: Option<String>,
    # [clap (long = "checksum-crc32" , name = "ChecksumCRC32" , help = "This header can be used as a data integrity check to verify that the data received is the same data that was originally sent. This specifies the base64-encoded, 32-bit CRC32 checksum of the object returned by the Object Lambda function. This may not match the checksum for the object stored in Amazon S3. Amazon S3 will perform validation of the checksum values only when the original <code>GetObject</code> request required checksum validation. For more information about checksums, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html\">Checking object integrity</a> in the <i>Amazon S3 User Guide</i>." , long_help = None)]
    checksum_crc32: Option<String>,
    # [clap (long = "request-route" , name = "RequestRoute" , help = "Route prefix to the HTTP URL generated." , long_help = None)]
    request_route: String,
    # [clap (long = "server-side-encryption" , name = "ServerSideEncryption" , help = "The server-side encryption algorithm used when storing requested object in Amazon S3 (for example, AES256, aws:kms)." , long_help = None)]
    server_side_encryption: Option<String>,
    # [clap (long = "restore" , name = "Restore" , help = "Provides information about object restoration operation and expiration time of the restored object copy." , long_help = None)]
    restore: Option<String>,
    # [clap (long = "ssekms-key-id" , name = "SSEKMSKeyId" , help = "If present, specifies the ID of the Amazon Web Services Key Management Service (Amazon Web Services KMS) symmetric customer managed key that was used for stored in Amazon S3 object." , long_help = None)]
    ssekms_key_id: Option<String>,
}
impl WriteGetObjectResponseCommand {
    pub async fn run(&self, s3: &'static aws_sdk_s3::Client) {
        log::info!("{:#?}", self);
        let res = s3
            .write_get_object_response()
            .set_body(None)
            .set_parts_count(self.parts_count)
            .set_metadata(None)
            .set_request_token(Some(self.request_token.to_owned()))
            .set_content_language(self.content_language.to_owned())
            .set_replication_status(None)
            .set_content_range(self.content_range.to_owned())
...
#[derive(clap :: Args, Debug, Clone)]
pub struct InputSerializationArgs {
    #[clap(long = "csv")]
    csv: Option<String>,
    #[clap(long = "json")]
    json: Option<String>,
    #[clap(long = "compression-type")]
...
#[derive(clap :: Args, Debug, Clone)]
pub struct RequestProgressArgs {
    #[clap(long = "enabled")]
    enabled: Option<String>,
}

#[derive(clap :: Args, Debug, Clone)]
pub struct OutputSerializationArgs {
    #[clap(long = "json")]
    json: Option<String>,
    #[clap(long = "csv")]
    csv: Option<String>,
...
#[derive(clap :: Parser, Debug, Clone)]
pub struct SelectObjectContentCommand {
    #[clap(flatten)]
    input_serialization: InputSerializationArgs,
    # [clap (long = "expression-type" , name = "ExpressionType" , help = "The type of the provided expression (for example, SQL)." , long_help = None)]
    expression_type: String,
    # [clap (long = "expected-bucket-owner" , name = "ExpectedBucketOwner" , help = "The account ID of the expected bucket owner. If the bucket is owned by a different account, the request fails with the HTTP status code <code>403 Forbidden</code> (access denied)." , long_help = None)]
    expected_bucket_owner: Option<String>,
    # [clap (long = "key" , name = "Key" , help = "The object key." , long_help = None)]
    key: String,
    # [clap (long = "expression" , name = "Expression" , help = "The expression that is used to query the object." , long_help = None)]
    expression: String,
    #[clap(flatten)]
    request_progress: RequestProgressArgs,
    # [clap (long = "sse-customer-key" , name = "SSECustomerKey" , help = "The server-side encryption (SSE) customer managed key. This parameter is needed only when the object was created using a checksum algorithm. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html\">Protecting data using SSE-C keys</a> in the <i>Amazon S3 User Guide</i>." , long_help = None)]
    sse_customer_key: Option<String>,
    # [clap (long = "bucket" , name = "Bucket" , help = "The S3 bucket." , long_help = None)]
    bucket: String,
    #[clap(flatten)]
    output_serialization: OutputSerializationArgs,
    #[clap(flatten)]
...
impl SelectObjectContentCommand {
    pub async fn run(&self, s3: &'static aws_sdk_s3::Client) {
        log::info!("{:#?}", self);
        let res = s3
            .select_object_content()
            .set_input_serialization(None)
            .set_expression_type(None)
            .set_expected_bucket_owner(self.expected_bucket_owner.to_owned())
            .set_key(Some(self.key.to_owned()))
            .set_expression(Some(self.expression.to_owned()))
            .set_request_progress(None)
            .set_sse_customer_key(self.sse_customer_key.to_owned())
            .set_bucket(Some(self.bucket.to_owned()))
            .set_output_serialization(None)
            .set_scan_range(None)
            .set_sse_customer_key_md5(self.sse_customer_key_md5.to_owned())
            .set_sse_customer_algorithm(self.sse_customer_algorithm.to_owned())
            .send()
