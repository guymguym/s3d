...
// }
// pub fn parse_s3_op_kind(req: &HttpRequest) -> Option<S3Ops> {
// }
...
pub fn resolve_op_kind(resource: S3Resource, req: &HttpRequest) -> Option<S3Ops> {
    match resource {
...
pub mod service {
    ...
    pub fn resolve(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
...
pub mod bucket {
    ...
    pub fn resolve_accelerate(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_acl(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_analytics(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::GET => {
                if req.has_param("id") {
    ...
    pub fn resolve_cors(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_encryption(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_intelligent_tiering(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::GET => {
                if req.has_param("id") {
    ...
    pub fn resolve_inventory(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::GET => {
                if req.has_param("id") {
    ...
    pub fn resolve_lifecycle(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_location(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::GET => Some(S3Ops::GetBucketLocation),
            _ => None,
        }
    }
    pub fn resolve_logging(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_metrics(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::GET => {
                if req.has_param("id") {
    ...
    pub fn resolve_notification(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_object_lock(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_ownership_controls(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_policy(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_policy_status(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::GET => Some(S3Ops::GetBucketPolicyStatus),
            _ => None,
        }
    }
    pub fn resolve_public_access_block(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_replication(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_request_payment(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_tagging(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_versioning(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_website(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
...
pub mod object {
    ...
    pub fn match_object(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::GET => Some(S3Ops::GetObject),
            &Method::HEAD => Some(S3Ops::HeadObject),
            &Method::PUT => {
                if req.headers().has_header(X_AMZ_COPY_SOURCE) {
    ...
    pub fn resolve_legal_hold(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_restore(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::POST => Some(S3Ops::RestoreObject),
            _ => None,
        }
    }
    pub fn resolve_retention(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_select_object_content(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_torrent(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
            &Method::GET => Some(S3Ops::GetObjectTorrent),
            _ => None,
        }
    }
    pub fn resolve_uploads(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_upload_id(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
    ...
    pub fn resolve_versions(req: &HttpRequest) -> Option<S3Ops> {
        match req.method() {
