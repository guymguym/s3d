...
pub fn list_buckets_input(req: &S3Request) -> Result<ListBucketsInput, S3Errors> {
    ListBucketsInput::builder()
        .build()
        .map_err(|err| S3Errors::Unhandled(err.into()))
}
...
pub fn list_objects_input(req: &S3Request) -> Result<ListObjectsInput, S3Errors> {
...
pub fn get_object_input(req: &S3Request) -> Result<GetObjectInput, S3Errors> {
